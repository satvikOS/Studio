...
const OUT = path.resolve(__dirname, 'screenshots', 'studio-v3-delete-multi');

test('Studio V3 — Delete removes the whole multi-select set (slice 514)', async () => {
  ...
  console.log('  slice 514: deleted all 3 → remaining', remaining);
